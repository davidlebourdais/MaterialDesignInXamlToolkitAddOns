...
namespace MaterialDesignThemes.Wpf.AddOns.Extensions
{
    ...
    {
        private static readonly MethodInfo _getDefaultGenericAccess = typeof(TypeExtensions).GetRuntimeMethod(nameof(GetDefaultGeneric), new Type[] { }); // stores access to GetDefaultGeneric.
        ...
        public static object GetDefault(this Type type) => _getDefaultGenericAccess.MakeGenericMethod(type).Invoke(null, null);
